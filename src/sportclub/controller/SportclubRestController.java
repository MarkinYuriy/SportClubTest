...
public class SportclubRestController {
    ...
    public @ResponseBody
    String registration(@RequestBody String json) {
    ...
    public @ResponseBody
    String getProfiles(@PathVariable String subProfiler) {
    ...
    public @ResponseBody
    String getProfilerById(@PathVariable String id) {
    ...
    public @ResponseBody
    String getProfile(@PathVariable String SubProfiler, @PathVariable String id) {
    ...
    public @ResponseBody
    String getClub(@PathVariable int id) {
    ...
    public @ResponseBody
    String getTeams(@PathVariable int clubId) {
    ...
    public @ResponseBody
    String getStuff(@PathVariable int id) {
        if (id == 0) {
            RequestSuccess rs = new RequestSuccess();
            rs.setData("empty id");
            rs.setStatus("unsuccess");
    ...
    public @ResponseBody
    String getStuff(@PathVariable int teamId, @PathVariable String subprofiler) {
        if (teamId == 0) {
            RequestSuccess rs = new RequestSuccess();
            rs.setData("empty id");
            rs.setStatus("unsuccess");
    ...
    public @ResponseBody
    String getTeam(@PathVariable int teamId) {
    ...
    public @ResponseBody
    String getRole(@PathVariable String id) {
        String res = "";
    ...
    @ResponseBody
    String updateClub(@RequestBody String json) {
    ...
    @ResponseBody
    String addClub(@RequestBody String json) {
        Club club = null;
        try {
            club = new ObjectMapper().readValue(json, Club.class);
        } catch (IOException e) {
    ...
    @ResponseBody
    String removeClub(@RequestBody String json) {
        Club club = null;
    ...
    @ResponseBody
    String removeProfiler(@RequestBody String json) {
        Profiler prf = null;
        String id = "";
        try {
    ...
    public @ResponseBody
    String updateProfiler(@RequestBody String json) {
    ...
    public @ResponseBody
    String addCourt(@RequestBody String json) {
    ...
    public @ResponseBody
    void getAnyRequest(@RequestBody String jpql)
...
//		ProfilerDeserializer pd = new ProfilerDeserializer();
    ...
    public @ResponseBody
    String getTeamByClub(@PathVariable String clubId) {
    ...
    public @ResponseBody
    String getProfileByTeam(@PathVariable String teamId) {
